...
export const ADVANCED_LEVELS = [
  advancedLevel({
    ...
    assignment: 'Each target is its seed followed by the seed’s first note.',
  ...
  advancedLevel({
    ...
    assignment: 'Each seed’s target is that seed followed by the other seed’s first note. That same note selects which of its two halls receives it.',
  ...
  advancedLevel({
    ...
    assignment: 'Each performance has two targets: the seed’s first note in the archive, and its remaining suffix in the other named hall.',
  ...
  advancedLevel({
    ...
    assignment: 'All four six-note seeds map to their shown targets by the same input-output relation.',
  ...
  advancedLevel({
    ...
    assignment: 'Six seeds map to three target halls. Several seeds share a target word; Reprise has a different target word.',
