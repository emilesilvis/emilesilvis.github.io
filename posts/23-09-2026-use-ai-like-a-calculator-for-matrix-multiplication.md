...
I’m busy [relearning maths from the ground up](/maths-is-now-the-best-part-of-my-day.html), and I hate doing matrix multiplication by hand. I mostly use a calculator. But is that okay?
...
<figure style="margin: 1.5rem 0;">
  <img src="../static/images/use-ai-like-a-calculator/matrix-dot-product.png" alt="Diagram of matrix multiplication: the row [1, 2, 3] and column [7, 9, 11] are highlighted, giving the dot product 58.">
  <figcaption><small>Image credit: <a href="https://www.mathsisfun.com/algebra/matrix-multiplying.html">Maths Is Fun</a>.</small></figcaption>
</figure>

The problem here is twofold.

<figure style="max-width: 240px; margin: 1.5rem auto;">
  <img src="../static/images/use-ai-like-a-calculator/numworks-calculator.png" alt="A NumWorks calculator multiplying two matrices and displaying the result: rows [18, 21, 24] and [40, 47, 54].">
  <figcaption><small>Image credit: <a href="https://www.numworks.com/">NumWorks</a>.</small></figcaption>
</figure>
...
![Handwritten notes explaining v = x i-hat + y j-hat: the columns of A show where the basis vectors land, so Av is x times the new i-hat plus y times the new j-hat.](../static/images/use-ai-like-a-calculator/handwritten-basis-vectors.png)
