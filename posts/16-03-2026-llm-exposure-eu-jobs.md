...
Cleaners: **1/10**.
Average across all European jobs: **{{eu_average_exposure}}/10**.
...
What does this mean? Honestly, it's hard to say. High exposure doesn't necessarily mean displacement — it might just mean augmentation. We're in uncharted territory, and I don't think anyone can be confident in knowing exactly how all this will play out.
